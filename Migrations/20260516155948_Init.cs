        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Piles_Folders_FolderId",
                        column: x => x.FolderId,
                        principalTable: "Folders",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PileNotes", x => new { x.PileId, x.NoteId });
                    table.ForeignKey(
                        name: "FK_PileNotes_Notes_NoteId",
                        column: x => x.NoteId,
                        principalTable: "Notes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PileNotes_Piles_PileId",
                        column: x => x.PileId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NoteVersions_NoteId_VersionNumber",
                table: "NoteVersions",
                columns: new[] { "NoteId", "VersionNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PileNotes_NoteId",
                table: "PileNotes",
                column: "NoteId");

            migrationBuilder.CreateIndex(
                name: "IX_Piles_FolderId",
                table: "Piles",
                column: "FolderId");
